...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    //-         .col-auto
    //-           a.boton.boton--b(:href="obtenerLink('/actividades/SENA - Actividad Didáctica CF4 - Storyline output/story.html')" target="_blank")
    //-             span Realizar
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        ...
        .tarjeta.tarjeta--azul.p-3
          .row.justify-content-around.align-items-center            
            .col-sm.mb-3.mb-sm-0
              p.fw-bold.mb-0 Definir los conceptos relacionados con el servicio y atención al cliente.
            .col-auto
